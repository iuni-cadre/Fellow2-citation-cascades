...
docs/source/_images/ipython-6-screenshot.png
docs/source/_images/jedi_type_inference_60.png
docs/source/_images/kernel_selector_screenshot.png
docs/source/_images/ms_visual_studio.png
docs/source/_images/notebook_specgram.png
docs/source/_images/ptshell_features.png
docs/source/_images/qtconsole.png
docs/source/_images/qtconsole_tabbed.png
docs/source/_images/unicode_completion.png
docs/source/_images/2.0/running-crop.png
docs/source/_images/2.0/running.png
docs/source/_images/2.0/treeview.png
docs/source/_images/2.0/user-interface.png
docs/source/_images/2.0/widgets.png
...
docs/source/install/kernel_install.rst
...
docs/source/whatsnew/github-stats-4.rst
...
docs/source/whatsnew/version3_widget_migration.rst
docs/source/whatsnew/version4.rst
docs/source/whatsnew/version5.rst
docs/source/whatsnew/version6.rst
...
examples/Embedding/embed_class_short.py
examples/Embedding/embed_function.py
...
examples/IPython Kernel/Cell Magics.ipynb
examples/IPython Kernel/Custom Display Logic.ipynb
examples/IPython Kernel/Importing Notebooks.ipynb
...
examples/IPython Kernel/SymPy.ipynb
examples/IPython Kernel/Terminal Usage.ipynb
examples/IPython Kernel/Third Party Rich Output.ipynb
examples/IPython Kernel/Trapezoid Rule.ipynb
examples/IPython Kernel/Updating Displays.ipynb
examples/IPython Kernel/Working With External Code.ipynb
examples/IPython Kernel/example-demo.py
examples/IPython Kernel/ipython-completion.bash
examples/IPython Kernel/ipython-get-history.py
examples/IPython Kernel/ipython.desktop
examples/IPython Kernel/data/flare.json
...
examples/IPython Kernel/nbpackage/__init__.py
examples/IPython Kernel/nbpackage/mynotebook.ipynb
examples/IPython Kernel/nbpackage/nbs/__init__.py
examples/IPython Kernel/nbpackage/nbs/other.ipynb
examples/images/FrontendKernel.png
examples/images/animation.m4v
examples/images/ipython_logo.png
examples/images/python_logo.svg
examples/images/FrontendKernel.graffle/data.plist
examples/images/FrontendKernel.graffle/image1.png
examples/utils/cwd_prompt.py
examples/utils/list_pyfiles.ipy
examples/utils/list_subdirs.ipy
