...
# installed.
TK_PREFIX='/home/jovyan/conda/dbconnect'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/jovyan/conda/dbconnect'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/jovyan/conda/dbconnect/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/jovyan/conda/dbconnect/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/jovyan/conda/dbconnect/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/home/jovyan/conda/dbconnect/lib/libtkstub8.6.a'
